...
[Ansible](../ansible/questions.md), [AWS](../aws/questions.md). Tham chiếu dạng `Common A2.3` trỏ tới bộ tương ứng. Chart của
app và dev/prod có bộ riêng: [App](../app/questions.md). Pipeline Jenkins có bộ riêng: [Jenkins](../jenkins/questions.md).
